...
<table class="pdfSmallTable">
  <tr>
    <th colspan="4"><b> GEOSUPPORT SYSTEM RETURN CODES, REASON CODES AND MESSAGES <br> (As of Geosupport Software Version 19.1 - <span class="smallText">unchanged since</span> V17.1) </b>
    </th>
  </tr>
  <tr>
    <td><b>GRC</b></td>
