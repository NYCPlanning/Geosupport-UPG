...
var _typeof = typeof Symbol === "function" && typeof Symbol.iterator === "symbol" ? function (obj) { return typeof obj; } : function (obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; /* eslint-disable no-param-reassign, import/no-unresolved,
...
var commands = {
    ...
    if (command.params.length > 1) {
      if (typeof command.params[1] === 'function') {
        ...
        objectSpace[command.target][command.params[0]] = function () {
          ...
          return callback.apply(objectSpace[command.target], args.concat(otherArgs));
        };
      } else {
        // If the second parameter is not a function then just assign
        var target = command.target,
            _command$params = _slicedToArray(command.params, 2),
            name = _command$params[0],
            value = _command$params[1];
  ...
  setting: function setting(command) {
    if (command.params.length === 2) {
      var target = command.target,
          _command$params2 = _slicedToArray(command.params, 2),
          name = _command$params2[0],
          value = _command$params2[1];
  ...
  windowProperty: function windowProperty(command) {
    if (command.params.length === 2) {
      var _command$params3 = _slicedToArray(command.params, 2),
          name = _command$params3[0],
          value = _command$params3[1];
  ...
  defineMethod: function defineMethod(command) {
    ...
    var _command$params4 = _slicedToArray(command.params, 2),
        name = _command$params4[0],
        value = _command$params4[1];
