...
<head>
  ...
  <script>
    ...
    var mkdocs_page_input_path = "node_modules\\phantomjs\\node_modules\\readable-stream\\doc\\stream.markdown";
...
<h3 id="class-streamduplex">Class: stream.Duplex</h3>
...
<h3 id="class-streamreadable">Class: stream.Readable</h3>
<!--type=class-->
...
<li>Calling the <a href="#stream_readable_resume"><code>stream.resume()</code></a> method to explicitly open the
  flow.</li>
<li>Calling the [<code>stream.pipe()</code>][] method to send the data to a <a href="#stream_class_stream_writable">Writable</a>.</li>
</ul>
...
<pre><code class="language-js">var readable = getReadableStreamSomehow();
...
<h4 id="event-readable">Event: 'readable'</h4>
...
hadn't already.</p>
<pre><code class="language-javascript">var readable = getReadableStreamSomehow();
...
<h4 id="readableispaused">readable.isPaused()</h4>
<ul>
...
<pre><code class="language-js">var readable = new stream.Readable
...
<h4 id="readablepause">readable.pause()</h4>
<ul>
...
<h4 id="readablepipedestination-options">readable.pipe(destination[, options])</h4>
<ul>
<li><code>destination</code> {stream.Writable} The destination for writing data</li>
<li><code>options</code> {Object} Pipe options</li>
...
chains like so:</p>
<pre><code class="language-js">var r = fs.createReadStream('file.txt');
...
<h4 id="readablereadsize">readable.read([size])</h4>
<ul>
...
<p>Note that calling <a href="#stream_readable_read_size"><code>stream.read([size])</code></a> after the [<code>'end'</code>][]
event has been triggered will return <code>null</code>. No runtime error will be raised.</p>
<h4 id="readableresume">readable.resume()</h4>
<ul>
<li>Return: <code>this</code></li>
</ul>
...
its [<code>'end'</code>][] event, you can call <a href="#stream_readable_resume"><code>stream.resume()</code></a> to open
the flow of data.</p>
<pre><code class="language-js">var readable = getReadableStreamSomehow();
readable.resume();
readable.on('end', () =&gt; {
...
<h4 id="readablesetencodingencoding">readable.setEncoding(encoding)</h4>
<ul>
...
<h4 id="readableunpipedestination">readable.unpipe([destination])</h4>
<ul>
<li><code>destination</code> {stream.Writable} Optional specific stream to unpipe</li>
</ul>
<p>This method will remove the hooks set up for a previous [<code>stream.pipe()</code>][]
call.</p>
...
<h4 id="readableunshiftchunk">readable.unshift(chunk)</h4>
<ul>
...
performing a read.</p>
<h4 id="readablewrapstream">readable.wrap(stream)</h4>
<ul>
...
<h3 id="class-streamtransform">Class: stream.Transform</h3>
...
<h3 id="class-streamwritable">Class: stream.Writable</h3>
<!--type=class-->
...
<h4 id="event-drain">Event: 'drain'</h4>
...
<h4 id="event-error_1">Event: 'error'</h4>
<ul>
<li>{Error}</li>
</ul>
...
<pre><code class="language-javascript">var writer = getWritableStreamSomehow();
for (var i = 0; i &lt; 100; i ++) {
...
<h4 id="event-pipe">Event: 'pipe'</h4>
<ul>
<li><code>src</code> {stream.Readable} source stream that is piping to this writable</li>
</ul>
<p>This is emitted whenever the [<code>stream.pipe()</code>][] method is called on a readable
stream, adding this writable to its set of destinations.</p>
<pre><code class="language-js">var writer = getWritableStreamSomehow();
...
<h4 id="event-unpipe">Event: 'unpipe'</h4>
<ul>
<li><code>src</code> {<a href="#stream_class_stream_readable">Readable</a> Stream} The source stream that
  [unpiped][<code>stream.unpipe()</code>] this writable</li>
</ul>
<p>This is emitted whenever the [<code>stream.unpipe()</code>][] method is called on a
...
<h4 id="writablecork">writable.cork()</h4>
...
<h4 id="writableendchunk-encoding-callback">writable.end([chunk][, encoding][, callback])</h4>
<ul>
...
<h4 id="writablesetdefaultencodingencoding">writable.setDefaultEncoding(encoding)</h4>
<ul>
<li><code>encoding</code> {String} The new default encoding</li>
</ul>
<p>Sets the default encoding for a writable stream.</p>
<h4 id="writableuncork">writable.uncork()</h4>
<p>Flush all data, buffered since [<code>stream.cork()</code>][] call.</p>
<h4 id="writablewritechunk-encoding-callback">writable.write(chunk[, encoding][, callback])</h4>
<ul>
...
<h3 id="class-streamduplex_1">Class: stream.Duplex</h3>
<!--type=class-->
...
<li><code>options</code> {Object} Passed to both Writable and Readable
  constructors. Also has the following fields:</li>
...
initialized.</p>
<h3 id="class-streampassthrough">Class: stream.PassThrough</h3>
...
<h3 id="class-streamreadable_1">Class: stream.Readable</h3>
<!--type=class-->
...
initialized.</p>
<h4 id="readable_readsize">readable._read(size)</h4>
<ul>
...
<a href="#stream_readable_read_size"><code>stream.read()</code></a> method when the [<code>'readable'</code>][] event fires.</p>
...
<pre><code class="language-js">// A parser for a simple data protocol.
...
<h3 id="class-streamtransform_1">Class: stream.Transform</h3>
...
<p>The [<code>'finish'</code>][] and [<code>'end'</code>][] events are from the parent Writable
...
has been called.</p>
<h4 id="transform_flushcallback">transform._flush(callback)</h4>
<ul>
...
<h4 id="transform_transformchunk-encoding-callback">transform._transform(chunk, encoding, callback)</h4>
<ul>
...
programs. However, you <strong>are</strong> expected to override this method in
your own extension classes.</p>
<h4 id="example-simpleprotocol-parser-v2">Example: <code>SimpleProtocol</code> parser v2</h4>
...
<h3 id="class-streamwritable_1">Class: stream.Writable</h3>
<!--type=class-->
...
<h4 id="new-streamwritableoptions">new stream.Writable([options])</h4>
<ul>
<li><code>options</code> {Object}</li>
...
constructor so that the buffering settings can be properly
initialized.</p>
<h4 id="writable_writechunk-encoding-callback">writable._write(chunk, encoding, callback)</h4>
<ul>
...
programs. However, you <strong>are</strong> expected to override this method in
your own extension classes.</p>
<h4 id="writable_writevchunks-callback">writable._writev(chunks, callback)</h4>
<ul>
...
<pre><code class="language-js">var duplex = new stream.Duplex({
  read: function(n) {
...
<pre><code class="language-js">var transform = new stream.Transform({
...
<pre><code class="language-js">var writable = new stream.Writable({
  write: function(chunk, encoding, next) {
    // sets this._write under the hood
...
<h3 id="streamread0"><code>stream.read(0)</code></h3>
...
<h3 id="streampush"><code>stream.push('')</code></h3>
